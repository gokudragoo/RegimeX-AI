...
const NAV_LINKS = [
  ...
  { label: "Strategy", href: "/strategy-center" },
  { label: "Backtest", href: "/backtesting-lab" },
    ...
    <div className="fixed inset-x-0 top-4 z-40 flex justify-center px-4 pointer-events-none">
      <div className="pointer-events-auto w-full max-w-3xl">
        ...
        <nav
          ...
          style={NAV_STYLE}
        >
          <a href="/" className="font-pixel text-xs tracking-[0.25em] text-black/70">REGIMEX</a>
        ...
        >
          ...
          >
            ...
            <div className="mt-1 px-2 pb-1">
              <a href="/dashboard" className="block w-full text-center text-[11px] px-4 py-2.5 rounded-xl border border-black/10 text-black/60 hover:text-black hover:border-black/20 hover:bg-black/[0.03] transition-all duration-200 tracking-wide" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
                OPEN APP
              </a>
            </div>
          </div>
